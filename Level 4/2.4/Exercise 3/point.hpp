...
public:
	...
	friend ostream& operator << (ostream& os, const point& p); //global function for ostream

	std::string toString() const;

	double distance(const point& p) const; //for exercise 2.2.2, distance between 2 points, modified in exercise 2.3.2 to const referance
