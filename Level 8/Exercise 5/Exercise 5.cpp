...
that have many applications to queueing theory, scheduling and jump (Levy) 
processes in finance

Modify the code in the file “TestNormalDistribution.cpp” to work with 
exponential distribution instead of normal distribution and 
...
int main()
{
	...
	normal_distribution<float> myExponential2; //default is standard normal
