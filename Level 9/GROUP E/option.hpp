...
public:
	...
	Vector<double, long> callPrice_withExcel(double S_start, double S_end, double diff);
	Vector<double, long> putPrice_withExcel(double S_start, double S_end, double diff);
